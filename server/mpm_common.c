...
/* Connections that modules accepted and manage outside of the MPM, noted
 * through the optional functions below so that a child stopping gracefully
 * can wait for them like it waits for its own.
 */
